...
Процедура Печать(ТабДок, Ссылка) Экспорт
	...
	Макет = Документы.СписаниеНаВнутренниеПотребности.ПолучитьМакет("Печать");
	Запрос = Новый Запрос;
	Запрос.Текст =
	"ВЫБРАТЬ
	|	СписаниеНаВнутренниеПотребности.Дата,
	|	СписаниеНаВнутренниеПотребности.Номер,
	|	СписаниеНаВнутренниеПотребности.Примечание,
	|	СписаниеНаВнутренниеПотребности.ТабличнаяЧасть1.(
	|		НомерСтроки,
	|		Номенклатура,
	|		Количество,
	|		ЕдИзм
	|	)
	|ИЗ
	|	Документ.СписаниеНаВнутренниеПотребности КАК СписаниеНаВнутренниеПотребности
	|ГДЕ
	|	СписаниеНаВнутренниеПотребности.Ссылка В (&Ссылка)";
